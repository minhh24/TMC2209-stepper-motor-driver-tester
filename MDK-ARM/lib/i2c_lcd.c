...
{
    lcd_send_cmd(lcd, 0x01);  // Command to clear display (Standard HD44780)
    HAL_Delay(2);             // Clearing display takes time
}
...
{
    // ÐÃ THÊM: T? d?ng gán d?a ch? 0x4E bên trong hàm init
    lcd->address = 0x4E; 
